...
public class ContDynamicsFlowsVisitor extends ContDynamicsBaseVisitor<BehaviorElement> {
	...
	@Override
	public BehaviorElement visitContinuousdynamics(@NotNull ContDynamicsParser.ContinuousdynamicsContext ctx) {
	...
	@Override
	public BehaviorElement visitAssignment(@NotNull ContDynamicsParser.AssignmentContext ctx) {
	...
	public SimpleExpression visitSimple_expression(@NotNull ContDynamicsParser.Simple_expressionContext ctx) {
		...
		if (ctx.unary_operator() != null) {
			expr.setUnaryAddingOperator(UnaryAddingOperator.MINUS);
		}
		return expr;
	}
